...
namespace Ares.Common.Api.Server
{
    ...
    /// This interface is safer than <see cref="ISignalStrengthTracker"/>.
    /// </summary>
    public interface ISignalStrengthTrackerProxy
    {
        /// <summary>
        ...
        void SetSignalStrength(SignalStrength signal, IPlayer player);
    }
}
